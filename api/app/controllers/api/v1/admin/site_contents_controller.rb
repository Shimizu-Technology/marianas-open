    ...
    module Admin
      class SiteContentsController < ApplicationController
        ...
        def site_content_params
          params.permit(:key, :content_type, :value_en, :value_ja, :value_ko, :value_tl, :value_zh, :value_zh_hant, :value_pt, :section, :label, :sort_order)
        end
