...
export default function ShopPage() {
  const { enabled, loading, error, products, reload } = useCommerce()

  return (
    <div className="min-h-screen pt-16">
      <SEO title="Official Shop" description="Shop official Marianas Open apparel and merchandise, available for shipping or pickup on Guam." />
